...
import Searchbar from '../../Components/HospitalSearchBar/HospitalSearchBar'

class SearchHospital extends Component {
    constructor(props) {
        super(props)
        this.state = {
            searchText: '',
        ...
        return (
            <div style={{ flex: 1, backgroundColor: 'aliceblue' }}>
                <div style={{ textAlign: 'center', margin: '10px' }}>
                    {listType.status || listType.testStatus} Hospitals
                </div>
                            ...
                            patientList.map(p => {
                                return <div
                                    ...
                                    <div className="patientNameCard">
                                        <div className="patientName">{p.lastName} Hospital</div>
                                        <div className="mobile">Contact : {p.phoneMobile}</div>
                                    </div>
                                    <div className="patientNameCard">
                                        {p.age ? <div className="dob">Total Bed :{p.age}</div> : null}
                                        {/* <div className="gender">{p.gender}</div> */}
                                    </div>
                                    <div className="medicalStatus">
                                        <div>
                                        {p.age ? <div className="dob">Occupied Bed :{parseInt(p.age)-17 }</div> : null}
                                        </div>
                                        {/* <div>
