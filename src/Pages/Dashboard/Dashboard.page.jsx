                    ...
                    <React.Fragment>
                        ...
                        {(patientRecords.length > 0) ?
                            <div style={{ padding: 10, paddingTop: 20 }}>
                                <div className='blockPanel'>
                                    <span className="panelTitle">Patient Record Capture</span>
                                </div>
                                <div className='blocksContainer'>
                                    {this.renderPatientRecords(patientRecords, 'testStatus')}
                                </div>
                            </div>
                            : null}
                        {/* {(patientStatus.length > 0) ?
                            <div style={{ padding: 10 }}>
                                <div className='blockPanel'>
                                    <span className="panelTitle">Patient Status</span>
                                </div>
                                <div className='blocksContainer'>
                                    {this.renderPatientRecords(patientStatus, 'status')}
                                </div>
                            </div>
                            : null} */}
                        <Button
...
const H = withRouter(Dashboard);

const DashboardPage = connect(mapStateToprops)(H);
