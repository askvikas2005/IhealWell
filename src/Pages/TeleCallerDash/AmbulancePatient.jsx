...
class AmbulancePatient extends Component {
    constructor(props) {
        super(props)
        this.state = {
            prescriptionModel: {},
      ...
      const assignID = patient.suggestedByDr.split('$');
       let body = { 
           ...
           // cronaPatientId:parseInt("12354"),
            ...
            orderStatus:patient.medicalStatus
          };
            ...
            if (data.status === "SUCCESS") {
                ...
                setTimeout(async () => {
                    await this.setState({ snackMessage: '' })
                        ...
                        this.props.history.push('/ambulancedash')
                }, 1500);
            } else {
    ...
    renderForm1 = () => {
        ...
        switch (this.state.stage) {
            case 1:
                return (
                    <div>
                        <form disabled='true' noValidate autoComplete="off">
                            ...
                            <FormLabel  className='inputStyles' component="legend" style={{ display: 'flex', flexDirection: 'row', backgroundColor: '#154c66', padding: 10, justifyContent: 'center',fontSize: 15, alignSelf: 'center',color:'white'}}>Demographic Information</FormLabel>
                                ...
                                <div><span style={{ color: 'blue',size:10}}>First Name</span> : <span>{patient.firstName}</span></div>
                                 
                                 <div><span style={{ color: 'blue',size:'10'}}>Last Name</span> : <span>{patient.lastName}</span></div>
                                 <div><span style={{ color: 'blue',size:'10'}}>Mobile Number</span> : <span>{patient.phoneMobile}</span></div>
                                 <div><span style={{ color: 'blue',size:'10'}}>DOB</span> : <span>{patient.dateOfBirth}</span></div>
                                 <div><span style={{ color: 'blue',size:'10'}}>Age</span> : <span>{patient.age}</span></div>
                                
                                </div>
                                <div>
                                <span style={{ color: 'blue',size:'10'}}>Address1</span> : <span>{patient.addressLineOne}</span>
                                 <span style={{ color: 'blue',size:'10'}}>Last Name</span> : <span>{patient.addressLineTwo}</span>
                                 <span style={{ color: 'blue',size:'10'}}>Area</span> : <span>{patient.area}</span>
                                 <span style={{ color: 'blue',size:'10'}}>Pincode</span> : <span>{patient.pinCode}</span>
                                </div>
                            </div>
                ...
                {gettingPatient ? <div style={{ textAlign: 'center', margin: '20px' }}>
                   ...
                   <div className='box'>
                       <FormLabel className='inputStyles' component="legend" style={{ display: 'flex', flexDirection: 'row', backgroundColor: '#154c66', padding: 10,fontSize: 15, alignSelf: 'center', color: 'white'}}>
                           Assign To Coordinator</FormLabel>
                       ...
                       <AutoTextField 
                           ...
                           <div>
                                <FormControl
                                    ...
                                    >
                                        {/* this.setState({ medicalStatus:'TCYES|TCDYES|HYES|ANO'}) */}
                                        <FormControlLabel value={'Completed By AC'} control={<Radio />} label="Completed" />
                                        <FormControlLabel value={'Abandoned By AC'} control={<Radio />} label="Abandoned" />
                                    </RadioGroup>
                                </FormControl>
                            </div>
                            <div>
                                        ...
                                        <FormLabel className='inputStyles' component="legend" style={{ display: 'flex', flexDirection: 'row', backgroundColor: '#154c66', padding: 10,fontSize: 15, alignSelf: 'center', color: 'white'}}>
                           Update Info</FormLabel>
                           <div style={{ textAlign: 'center' }}>
                                <div style={{ color: 'red' }}>{errorMsg}</div>
                                <Button type="button" variant="contained" color="primary" onClick={() => !saving && this.updateHistory()}>{!saving ? 'Submit' : 'Please wait'}</Button>
                            </div>
                            </div>
                       <div >
                       {this.renderForm1()}
...
export default withStyles(useStyles)(connect(mapStateToprops)(AmbulancePatient));
