...
import './CallCenterDoctorDash.css'
...
class CallCenterDoctorDash extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            patientRecords: [],
            patientStatus: [],
            headerT:'Welcome To Call Center caller DashBoard.....Please Click On Summery...',
            update: ''
        }
    ...
    renderTotalEnrolledPatient = (statusArray, forType) => {
        return (
            ...
            <div style={{ alignSelf: 'center', fontSize: 20 }}>All Patient</div> 
                </Card>
             } })
        )
    }
    ...
    MenuOne = () => {
        return (
               this.setState({ headerT: 'Registration Form -Telecaller' })
        )
    }
    MenuTwo = () => {
        return (
    ...
    render() {
        ...
        const switchView = () => {
            ...
            switch(this.state.headerT) 
            {
              ...
              case "Registration Form -Telecaller":   
                ...
                {gettingDash ?
                    ...
                    <React.Fragment>
                        ...
                        <div style={{ padding: 10, paddingTop: 20 }}>
                                ...
                                {/* <Button variant="contained" color="primary" onClick={()=>this.MenuOne()}>Registration Form -Telecaller</Button>
...
export default withStyles(useStyles)(connect(mapStateToprops)(CallCenterDoctorDash));
