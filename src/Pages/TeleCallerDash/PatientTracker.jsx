...
alert(JSON.stringify(body.cronaPatientTestResultModel))
        ...
        return (
            <>
                {gettingPatient ? <div style={{ textAlign: 'center', margin: '20px' }}>
                    ...
                    <div style={{ backgroundColor: 'aliceblue', flex: 1 ,display: 'flex', flexDirection: 'row'}}>
                        <div style={{ backgroundColor: 'aliceblue', flex: 1 ,display: 'flex', flexDirection: 'row'}}>
                            <table style={{width:'100%'}}>
                                ...
                                <div className="card1"
                                    ...
                                    <span style={{ fontSize: 15, alignSelf: 'center', color: 'white' }}>
                                        Patient Demographic
                                    </span>
                                    </div>
                                            <div className="card1"
                                    style={{ display: 'flex', flexDirection: 'column', backgroundColor: 'lightblue', padding: 10, justifyContent: 'left' }}>
                                   
                                    <span style={{ fontSize: 15, alignSelf: 'left', color: 'blue',justifyContent: 'left' }}>
                                        Patient Name: {patient.firstName} {patient.lastName}</span><br></br>
                                        <span style={{ fontSize: 15, alignSelf: 'left', color: 'blue',justifyContent: 'left' }}>  
...
export default withStyles(useStyles)(connect(mapStateToprops)(PatientTracker));
