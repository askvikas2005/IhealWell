...
class CallCenterDoctorUpdate1 extends Component {
    constructor(props) {
        super(props)
        this.state = {
            prescriptionModel: {},
                ...
                {gettingPatient ? <div style={{ textAlign: 'center', margin: '20px' }}>
                   ...
                   <div className='box'>
                       <FormLabel className='inputStyles' component="legend" style={{ display: 'flex', flexDirection: 'row', backgroundColor: '#154c66', padding: 10,fontSize: 15, alignSelf: 'center', color: 'white'}}>
                           Assign Form To Tele Caller</FormLabel>
                   <div style={{ display: 'flex', flexDirection: 'row',padding:5,marginLeft:'5'}}>
                       <AutoTextField 
                                   id={'Assign'}
                                   label={'Assign To Tele Caller'}
                                   value={patient.area}
                                   list={availableAreas}
                                   setInput={(v) => this.setPatientInput('area', v)}
                                   getApi={() => this.getAutoAddress()}
                           ...
                           <div>
                                <FormControl
                                    ...
                                    >
                                        {/* this.setState({ medicalStatus:'TCYES|TCDYES|HYES|ANO'}) */}
                                        <FormControlLabel value={'TCYES|TCDYES|HNO|AYES'} control={<Radio />} label="Agree" />
                                        <FormControlLabel value={'TCYES|TCDYES|HNO|ANO'} control={<Radio />} label="DisAgree" />
                                    </RadioGroup>
                                </FormControl>
                            </div>
                            <div>
...
export default withStyles(useStyles)(connect(mapStateToprops)(CallCenterDoctorUpdate1));
