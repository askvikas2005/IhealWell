...
import './AmbulanceDash.css'
import Searchbar from '../../Components/SearchBar/Searchbar.component'

class ambulancedash extends Component {
    constructor(props) {
        super(props)
        this.state = {
            patient: {
    ...
    gotoPatient1 = patient => {
        ...
        this.props.history.push('/ambulancepatient')
    ...
    gotoPatient = patient => {
        ...
        // this.props.history.push('/tellecallerupdatepatient')
       // this.props.history.push('/tellecallerupdatepatient')
        this.props.history.push('/ambulanceatient')
                                ...
                                return <div
                                    ...
                                    <div className="medicalStatus">
                                        <div>
                                            ...
                                            Suggested By Tellecaller Doctor
                                        </div>
                                    </div>
...
export default connect(mapStateToprops)(ambulancedash);
