...
import './SearchPaitentByStatus.css'
import Searchbar from '../../Components/SearchBar/Searchbar.component'

class SearchPaitentByStatus extends Component {
    constructor(props) {
        super(props)
        this.state = {
            patient: {
                                    ...
                                    p.medicalStatus=='TCYES|TCDYES|HYES|AYES')
                            {
                                return <div
                                    ...
                                    <div className="medicalStatus" style={{ color:'blue'}}>
                                        <div  >
                                             {/* {p.medicalStatus ? <span className="dob">Severity:</span> : ''}{' '}{p.medicalStatus}  */}
                                             Suggested By Telecaller Doctor
                                        </div>
                                    </div>
                                    <div className="nextDiv">
                                        <NavigateNextIcon />
...
export default connect(mapStateToprops)(SearchPaitentByStatus);
