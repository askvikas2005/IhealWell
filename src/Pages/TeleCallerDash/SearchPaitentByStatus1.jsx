...
import './SearchPaitentByStatus1.css'
import Searchbar from '../../Components/SearchBar/Searchbar.component'

class SearchPaitentByStatus1 extends Component {
    constructor(props) {
        super(props)
        this.state = {
            patient: {
...
export default connect(mapStateToprops)(SearchPaitentByStatus1);
